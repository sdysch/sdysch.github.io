...
## AI ranked RSS feeds
- [https://github.com/sdysch/daily_rss_digest](https://github.com/sdysch/daily_rss_digest) 
- Automated daily digest of curated RSS feeds straight to your phone
- See the [post](../my-own-curated-rss-feed)

## Personal Rightmove new listings and price drop alerts
- [https://github.com/sdysch/rightmove_scraper](https://github.com/sdysch/rightmove_scraper) 
- Setup your own Rightmove house listing texts to your phone via Telegram

## Diabetes CGM data LLM assistant
- [https://github.com/sdysch/cgm-llm-assistant/](https://github.com/sdysch/cgm-llm-assistant/) 
...
- Scraping data from [berightbackapp.io](https://berightbackapp.io); Julie Naismith's method for separation anxiety training + simple streamlit dashboard

## Diabetes sensor data
- [https://github.com/sdysch/diabetes-ml](https://github.com/sdysch/diabetes-ml)
- Scraping freestyle libre data from [LibreView](https://www.libreview.com), looking at building hypo predictions
...
- Scraping data from [chess.com](https://chess.com), correlation analysis of puzzle and game ratings
